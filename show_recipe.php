...
<?php
  ...
  <?php
    ...
    $sql5 = "SELECT review_id from reviews where rid = $rid";

    $result5 = $conn->query($sql5);

    if (mysqli_num_rows($result5) > 0) {

      $sql6 = "select uname, review_title, review_description, rv.rating, ri.stars from reviews rv join review_image ri
                on rv.rating = ri.rating
                where rid = $rid";
...
<?php
      while($row6 = mysqli_fetch_assoc($result6)) {
        ...
        <div class="card">
          <div class="container">
            <table><tr><td style="padding: 10px";><h4><b><?=$row6['review_title']?></b></h4></td><td style="padding: 20px";><img src="<?php echo $x; ?>" width= 118px height=30px></img></td></tr>
            <tr></tr>
            </table>
            <tr><td><?= $row6['review_description']?></td></tr>
            <p><tr><td>Submitted By:  <?=$row6['uname']?></td><tr></p>
          </div>
        </div>
...
<br>
<a href="review.php?data1=<?php echo $data1?>" <button type="button" class="btn btn-info" ">Add a review</button></a>
...
<a href = "show_recipe.php?data1=<?php echo $row4['title']?>&data2=<?php echo $row4['recipe_image_url']?>&data3=<?php echo $row4['rid']?>">
<div class="card">
  <img src=" <?php echo $row4['recipe_image_url']?> " width=427px height=240px alt="Avatar" style="width:100%">
  <div class="container" style = "width:100%">
    <h4 style= "text-align:center";><b><?php echo $row4['title']?></b></h4>
